...
/** One-time display of a freshly issued API key (mirrors NewSecretDialog). */
        ...
        <div className="p-5">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <h3 className="text-sm font-semibold text-[var(--text)]">New API key</h3>
