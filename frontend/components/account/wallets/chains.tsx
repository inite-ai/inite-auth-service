...
export const getChainIcon = (chain: string) => {
  switch (chain.toLowerCase()) {
    case 'ethereum':
      return (
        <svg className="h-4 w-4" viewBox="0 0 256 417" fill="currentColor">
    ...
    case 'polygon':
      return (
        <svg className="h-4 w-4" viewBox="0 0 178 178" fill="currentColor">
    ...
    case 'ton':
      return (
        <svg className="h-4 w-4" viewBox="0 0 56 56" fill="currentColor">
    ...
    case 'bsc':
      return (
        <svg className="h-4 w-4" viewBox="0 0 126 126" fill="currentColor">
