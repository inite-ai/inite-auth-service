 ...
 * project root (resolved via tsconfig paths) and applies it to every
 * .mdx page. Keep it small — the Tailwind classes here define the
 * docs typography pass, so every page inherits one consistent look
 * without needing a `prose` wrapper inside each MDX file.
 */
